...
// Récupérer les UEs et matières du vacataire
$sql = "SELECT DISTINCT m.nom AS nom_matiere, ue.type_enseignement, ue.id_ue
...
if ($stmt_vacataire === false) {
    die("Erreur de préparation (vacataire) : " . $conn->error);
}
...
// Compter les UEs assignées
$sql_ue_count = "SELECT COUNT(*) as count FROM vacataires_ues WHERE id_vacataire = ?";
$stmt_ue_count = $conn->prepare($sql_ue_count);
if ($stmt_ue_count === false) {
    die("Erreur de préparation (count) : " . $conn->error);
}
$stmt_ue_count->bind_param("i", $id_vacataire);
$stmt_ue_count->execute();
$result_ue_count = $stmt_ue_count->get_result();
$ue_count = $result_ue_count->fetch_assoc()['count'];

// Année scolaire (à adapter)
...
<body>
    ...
    <div class="header">
        <div class="header-left">
            ...
            <h1>Tableau de Bord Vacataire</h1>
        </div>
    ...
    <div class="main-container">
        ...
        <nav class="sidebar">
            ...
            <div class="sidebar-menu">
                <!-- Tableau de bord -->
                <div class="nav-item">
                    <a href="dashboard_vacataire.php" class="nav-link active">
                ...
                <!-- Mes matières -->
                <div class="nav-item">
                    <a href="Mes_matieres.php" class="nav-link">
        ...
        <div class="main-content">
            ...
            <div class="stats-cards">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        ...
                        <div class="stat-label">Notes à uploader</div>
                    </div>
                </div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        <div class="stat-number"><?= htmlspecialchars($annee_scolaire) ?></div>
                        <div class="stat-label">Année scolaire</div>
                    </div>
                </div>
            </div>
            ...
            <div class="info-section">
                ...
                <div class="info-grid">
                    <?php if (isset($vacataire)): ?>
                        <div class="info-item">
                            <div class="info-label">Nom</div>
                            <div class="info-value"><?= htmlspecialchars($vacataire['nom']) ?></div>
                        </div>
                        <div class="info-item">
                            <div class="info-label">Prénom</div>
                            <div class="info-value"><?= htmlspecialchars($vacataire['prenom']) ?></div>
                        </div>
                        <div class="info-item">
                            <div class="info-label">Email</div>
                            <div class="info-value"><?= htmlspecialchars($vacataire['email']) ?></div>
                        </div>
                        <div class="info-item">
                            <div class="info-label">Spécialité</div>
                            <div class="info-value"><?= htmlspecialchars($vacataire['specialite'] ?? 'Non spécifié') ?></div>
                        </div>
                        <div class="info-item">
                            <div class="info-label">Statut</div>
                            <div class="info-value"><?= htmlspecialchars($vacataire['statut'] ?? 'Vacataire') ?></div>
                        </div>
                    <?php else: ?>
                        <div class="info-item">
                            <div class="info-value">Informations non disponibles</div>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
